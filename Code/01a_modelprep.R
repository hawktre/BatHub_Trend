...
detections <- read_csv(here("DataProcessed.nosync/detections/detections_formatted_2016-2022.csv"))
...
## Bat Grid Covars
covars <- covars %>% arrange(cell)

## Max reps
max_reps <- max(spatial_reps_summary$spatial_reps)
